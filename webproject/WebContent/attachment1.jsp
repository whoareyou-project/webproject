...
<body>
	...
	<tr>  
	   ...
	   <td>전혀그렇지않다<input class="attach" type="radio" name="answer" value="1"/></td>
	   <td>그렇지않다<input class="attach" type="radio" name="answer" value="2"/></td>
	   <td>보통이다<input class="attach" type="radio" name="answer" value="3"/></td>
	   <td>대체로그렇다<input class="attach" type="radio" name="answer" value="4"/></td>
	   <td>매우그렇다<input class="attach" type="radio" name="answer" value="5"/></td>  
    </tr>    
    <br>
    <br>
