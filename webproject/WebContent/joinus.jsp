      ...
      <div class="container py-1">
        <div class="row align-items-center">
          <div class="col-8 col-md-8 col-lg-4">
            <h1 class="mb-0"><a href="index2.html" class="text-white h2 mb-0"><strong>WHO ARE YOU<span
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="mb-5">
            <h3 class="footer-heading mb-4">회원가입</h3>
  ...
  <input type="hidden" name="command" value="memberInsert"> 
            ...
            <div class="row form-group">
              <div class="col-md-12 mb-3 mb-md-0">
                ...
                <input type="text" name="id" class="form-control" placeholder="아이디를 입력하세요" maxlength="50">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="pw">PassWord</label>
                <input type="password" name="pw" class="form-control" placeholder="비밀번호를 입력하세요" maxlength="50">
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <input type="text" name="name" maxlength="50" class="form-control" placeholder="이름을 입력하세요">
              </div>
            </div>
   ...
   <div class="row form-group">
              <div class="col-md-12">
                ...
                <input type="text" name="age" maxlength="50" class="form-control" placeholder="나이를 입력하세요">
              </div>
            </div>
                      <div class="row form-group">
              <div class="col-md-12">
                ...
                <input type="radio" name="sex" value="여" checked>여  </div>
            </div>
            
              <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="birthday">Birthday</label>
                <input type="text" name="birthday" maxlength="50" class="form-control" placeholder="나이를 입력하세요">
              </div>
            </div>
     ...
     <div class="row form-group">
              <div class="col-md-12">
                ...
                <input type="text" name="job" maxlength="50" class="form-control" placeholder="직업을 입력하세요">
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <input type="text" name="height" maxlength="50" class="form-control" placeholder="키를 입력하세요">
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <input type="submit" value="가입" class="btn btn-primary py-3 px-4">
            
             &nbsp;&nbsp;&nbsp;   <input type="button" value="취소" onclick="location.href='index2.html'" class="btn btn-primary py-3 px-4">
              </div>
            </div>
