...
<%-- <div class="row align-items-center justify-content-center">
				<div class="col-md-7 text-center" data-aos="fade-up"
					...
					<h5 class="col-lg-8 d"> ${requestScope.errorMsg}
		<br><br><br></h5>
...
<%--  <div class="col-lg-8  text-center bcenter"> 
 <a  class="btn btn-primary py-3 px-4" href="control?command=memberUpdateReq&memberId=${member.id}">modi</a>
</div> --%>
<div class="row align-items-center justify-content-center">
				<div class="col-md-10 text-center dw" data-aos="fade-up"
					data-aos-delay="400">
