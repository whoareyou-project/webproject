...
<div class="container">        
    ...
    <script>
    	function attachscore(){
    	    ...
    	    var itemtypeArray = new Array("주요 양육자의 냉담하고 방임하는 태도 또는 일관되지 못한 반응을 자녀가 지속적으로 경험하였다면 그 자녀는 적절한 감정표현에 서툴거나 무관심한 양상을 나타낼 수 있다. 이들은 어린 시절 양육자로부터 따뜻한 사랑을 받기를 속으로 원하나 실제로 충족할 만큼 받지 못했기 때문에 상처받는 것으로부터 자신을 보호하기 위해 애착 욕구를 차단하고 깊이 있는 유대감을 형성하는 것을 피한다. 그리하여 “상대방(이성친구)이 어떻게 하든지 나와는 상관없어”의 태도를 나타낸다.","친밀감을 충족하고 위로와 보살핌 속에서 관계 내 신뢰를 경험하였기 때문에 안정적인 마음과 정서적 균형을 이루면서 이성친구와의 관계를 유지한다. 또한 친밀함과 타인의 도움을 편안하게 느끼며 관계에서 배신당하고 버려지리라는 염려로 시간을 낭비하지 않는다. ","주요 양육자가 감정 기복이 심해 일관되지 못한 반응과 양육태도를 자녀에게 주로 지속적으로 보였다면 그 자녀 역시 불안해하거나 분노하거나 감정기복이 심한 태도를 형성할 수 있다. 이러한 애착의 양상은 아동기, 청소년기를 지나 성인기의 관계형성에도 영향을 미친다. 다른 사람과의 친밀하고 긴밀한 유대관계를 형성할 때 감정에 압도되고, 언제 상대방으로부터 거절당할지 모른다는 걱정이 앞서며, 습관적으로 자신을 사랑하는지를 상대방에게 묻는 양상을 나타낸다.");
    	    if(score < 50)  {	
